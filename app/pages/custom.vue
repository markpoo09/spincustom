    ...
    <div class="container-main">
      ...
      <div class="preview-section">
        <div class="preview-card position-relative">
          ...
          <div
            class="product-info-block d-flex flex-column align-items-center mt-3 text-center"
          >
            <h3 class="product-name">
              {{ vinylTypes[selectedType - 1].name }}
            </h3>
          ...
          <div v-if="currentStep === 1" class="step-container">
            ...
            <div class="grid-2x2">
              ...
              >
                ...
                <p v-if="selectedType === index + 1" class="type-label">
                  {{ item.label }}
                </p>
              </div>
            </div>
          ...
          <div v-else-if="currentStep === 2" class="step-container">
            ...
            <div class="tools-grid-2">
              <div class="tool-panel">
                <h4 class="panel-title mb-3">ตัวอย่าง (SVG)</h4>
                <div
                  style="
                    display: flex;
                    align-items: center;
                ...
                <h4 class="panel-title mt-4 mb-2">แต่งสีตามใจ</h4>
                <div class="color-groups-wrapper">
                  <div
                    class="color-group mb-3"
                    v-for="(label, partId) in colorParts"
                    :key="partId"
                  >
                    ...
                    <div class="d-flex gap-2 justify-content-center align-items-center">
                      <div
                        :style="{
                          width: '36px',
                          height: '36px',
                          backgroundColor: selectedColors[partId],
                          borderRadius: '6px',
                          border: '1px solid rgba(0,0,0,0.2)'
                        }"
                      />
                      <PickColor
                        :modelValue="selectedColors[partId]"
                        @update:modelValue="(val) => applyColor(partId, val)"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div class="tool-panel">
                ...
                <!-- <div class="pattern-grid">
                  <div
                    ...
                    :key="index"
                    @click="applyPattern(pattern, index)"
                  >
                  ...
                  <div class="pattern-item" @click="applyPattern(null, -1)">
                    ...
                    <div
                      class="pattern-image-wrapper text-center d-flex align-items-center justify-content-center"
...
const vinylTypes = ref([
  {
    id: 1,
    name: "เป็นเครื่องที่ใช้งานง่าย ปรับน้อย",
    desc: "ไม่ต้องปรับหรือจูนเสียงให้ยุ่งยาก",
    label: "เป็นเครื่องที่เน้นใช้งานง่าย ปรับน้อย",
    image: "/vinyl_1.png",
  },
  {
    id: 2,
    name: "ดีไซน์คลาสสิก ลำโพงในตัว",
    desc: "เหมาะสำหรับผู้เริ่มต้น",
    label: "ดีไซน์คลาสสิก ลำโพงในตัว",
    image: "/vinyl_2.png",
  },
  {
    id: 3,
    name: "พกพาง่าย สไตล์กระเป๋าหิ้ว",
    desc: "พกพาไปได้ทุกที่",
    label: "พกพาง่าย สไตล์กระเป๋าหิ้ว",
    image: "/vinyl_3.png",
  },
  {
    id: 4,
    name: "ระดับโปร ปรับแต่งได้ทุกจุด",
    desc: "สำหรับออดิโอไฟล์ตัวจริง",
    label: "ระดับโปร ปรับแต่งได้ทุกจุด",
    image: "/vinyl_4.png",
  },
]);
...
async function updatePreviewImage() {
  ...
  try {
    ...
    const img = await fabric.FabricImage.fromURL(currentType.image, {
...
function applyColor(partId, hexColor) {
  // normalize hex (in case input type=color gives lowercase)
  selectedColors.value[partId] = hexColor.toUpperCase();
}
